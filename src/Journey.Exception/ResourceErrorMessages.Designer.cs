...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string DATE_TRIP_MUST_BE_LATTER_THAN_TODAY {
            get {
                return ResourceManager.GetString("DATE_TRIP_MUST_BE_LATTER_THAN_TODAY", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a The end date of the trip must be equal or latter than start date..
        /// </summary>
        public static string END_DATE_TRIP_MUST_BE_LATTER_THAN_START_DATE {
            get {
                return ResourceManager.GetString("END_DATE_TRIP_MUST_BE_LATTER_THAN_START_DATE", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Trip ID not found..
        /// </summary>
